...
📌 **Word Cloud**를 통해 **각 종교별 주요 키워드를 직관적으로 파악**할 수 있었음

📌 **LDA Topic Modeling**을 통해 **뉴스 기사에서 숨겨진 주제 구조를 분석**할 수 있었음

📌 **pyLDAvis 시각화**를 활용하여 **토픽 간 관계와 중요 단어를 효과적으로 분석**할 수 있었음
